...
/* harmony import */ var _modules_hoverImages__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/hoverImages */ "./src/js/modules/hoverImages.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_3__["default"])("[name=text]");
  Object(_modules_checkTextInputs__WEBPACK_IMPORTED_MODULE_3__["default"])("[name=message]");
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_11__["default"])();
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_2__["default"])("#size", "#material", "#options", "input.promocode", ".calc-price");
  Object(_modules_filters__WEBPACK_IMPORTED_MODULE_5__["default"])(".portfolio-menu", ".portfolio-wrapper", ".portfolio-no", "active");
  Object(_modules_hoverImages__WEBPACK_IMPORTED_MODULE_7__["default"])(".sizes-block");
  ...
  Object(_modules_scrolling__WEBPACK_IMPORTED_MODULE_10__["default"])(".pageup"); //                        //Pure JS scrolling
...
var burger = function burger(btnSelector, menuSelector) {
  ...
  burgerBtn.addEventListener("click", function () {
    ...
    burgerMenu.style.display = toggleMenu && window.screen.availWidth < 993 ? "block" : "none";
  });
  window.addEventListener("resize", function () {
    return window.screen.availWidth > 992 && (burgerMenu.style.display = "none");
  });
};
...
var drop = function drop() {
  ...
  function highlight(item) {
    item.closest(".file_upload").style.cssText = "border:5px solid yellow; background-color:rgba(0,0,0,0.7);";
  }

  function unhighlight(item) {
    var bgcolor = item.closest(".calc") && "#fff" || item.closest(".popup-content") && "#ededed" || item.closest(".file_upload") && "#f7e7e6";
    item.closest(".file_upload").style.cssText = "border:none; background-color:".concat(bgcolor, " ");
  }
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener("drop", function (e) {
      ...
      var name = arr[0].slice(0, 6) + dots + arr[arr.length - 1];
...
var filters = function filters(tabsParentSelector, tabContentsParentSelector, notYetClass, active) {
  ...
  function filterContents(e) {
    var contents = tabContentsParent.childNodes;
    contents.forEach(function (content) {
      return content.classList && ((content.style.display = "none") || content.classList.remove("animated", "fadeIn"));
    });
    var filteredContents = Array.from(contents).filter(function (content) {
      return content.classList && content.classList.contains(e.target.classList);
    });
    filteredContents.forEach(function (content) {
      return (content.style.display = "block") && content.classList.add("animated", "fadeIn");
    });
  ...
  tabs.forEach(function (tab) {
    tab.classList && tab.addEventListener("click", function (e) {
      tabs.forEach(function (tab) {
        return tab.classList && tab.classList.remove(active);
      });
      filterContents(e);
...
var hoverImages = function hoverImages(blocksSelector) {
  var imgBlocks = document.querySelectorAll(blocksSelector);
  ...
  imgBlocks.forEach(function (imgBlock) {
    imgBlock.addEventListener("mouseover", function () {
      return showImg(imgBlock);
    });
    imgBlock.addEventListener("mouseout", function () {
      return hideImg(imgBlock);
    });
  });
};

/* harmony default export */ __webpack_exports__["default"] = (hoverImages);
...
var scrolling = function scrolling(scrollSelector) {
  var iconSelector = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ".pageup";
  var scrollIcons = document.querySelectorAll(scrollSelector);
  scrollIcons.forEach(function (scrollIcon) {
      ...
      link.addEventListener("click", function (e) {
        ...
        function frame(time) {
          ...
          var progress = time - start,
              dir = toBlock < 0 ? Math.max(scrollTop - progress / speed, scrollTop + toBlock) : Math.min(scrollTop + progress / speed, scrollTop + toBlock);
